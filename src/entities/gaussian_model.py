...
class GaussianModel:
    ...
    def add_points(self, pcd: o3d.geometry.PointCloud, global_scale_init=True):
        ...
        new_color_variance = torch.full((n_new_points, 3), VALUE_INIT, device="cuda", dtype=torch.float32)
    ...
    def load_ply(self, path):
        ...
        if color_var_names:  # Check if color variance exists
            ...
            color_variances = np.full((xyz.shape[0], 3), 0.0)
    ...
    def densification_postfix(self, new_xyz, new_features_dc, new_features_rest,
        ...
        if new_color_variance is not None:
            ...
            default_color_variance = torch.full((n_points, 3), VALUE_INIT, device="cuda", dtype=torch.float32)
    ...
    def create_from_pcd(self, pcd: BasicPointCloud, spatial_lr_scale: float):
        ...
        initial_color_variance = torch.full((n_points, 3), VALUE_INIT, device="cuda", dtype=torch.float32)
